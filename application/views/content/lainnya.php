                    ...
                    <div class="table-responsive">
                        <table class="table text-nowrap datatable">
                            ...
                            <tbody id="show_lembaga">
                                <?php
                                $no = 1;
                                foreach ($get_unit as $sub1) {
                                ?>
                                    <tr>
                                        <td><?= $no++ ?></td>
                                        <td><?= $sub1->lembaga_unit ?></td>
                                        <td>
                                            <?php if ($sub1->peruntukancount == 0) : ?>
                                                <a href="javascript:void(0);" class="btn btn-danger deleteLembaga" data-id="<?= $sub1->idperuntukan ?>"><svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                        <path d="M4 7h16" />
                                            ...
                                            <?php else : ?>
                                                <a href="javascript:void(0);" class="btn btn-warning blockDeleteLembaga"><svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                        <path d="M4 7h16" />
                                                        <path d="M5 7l1 12a2 2 0 0 0 2 2h8a2 2 0 0 0 2 -2l1 -12" />
                                                        <path d="M9 7v-3a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v3" />
                    ...
                    <div class="table-responsive">
                        <table id="datatable" class="table text-nowrap datatable">
                            ...
                            <tbody id="show_lokasi">
                                <?php
                                $noo = 1;
                                foreach ($get_location as $sub2) {
                                ?>
                                    <tr>
                                        <td><?= $noo++ ?></td>
                                        <td><?= $sub2->nama_lokasi ?></td>
                                        <td>
                                            <?php if ($sub2->lokasicount == 0) : ?>
                                                <a href="javascript:void(0);" class="btn btn-danger deleteLokasi" data-id="<?= $sub2->idlokasi ?>"><svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                        <path d="M4 7h16" />
                                                        <path d="M5 7l1 12a2 2 0 0 0 2 2h8a2 2 0 0 0 2 -2l1 -12" />
                                                        <path d="M9 7v-3a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v3" />
                                            ...
                                            <?php else : ?>
                                                <a href="javascript:void(0);" class="btn btn-warning blockDeleteLokasi"><svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                        <path d="M4 7h16" />
                                                        <path d="M5 7l1 12a2 2 0 0 0 2 2h8a2 2 0 0 0 2 -2l1 -12" />
                                                        <path d="M9 7v-3a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v3" />
